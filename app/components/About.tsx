...
export default function AboutSection() {
  return (
    <>
      <section
        className="mx-auto container min-h-screen flex flex-col items-center justify-center"
        id="about"
      >
        <div>
          ...
          <p className="pt-8 font-head font-bold text-4xl md:text-7xl">
            <Balancer>
          ...
          <ul className="pt-8">
            <li className="flex items-center justify-between gap-8 border-t border-b border-zinc-700">
              ...
              <p className="text-xl hidden md:block">
                I can build beautiful and responsive frontend
              </p>
            </li>
            <li className="flex items-center justify-between gap-8 border-t border-b border-zinc-700">
              <h2 className="text-4xl md:text-8xl font-head uppercase font-bold">
              ...
              <p className="text-xl hidden md:block">
                I can build highly performant and scalable backends.
              </p>
            </li>
            <li className="flex items-center justify-between gap-8 border-t border-b border-zinc-700">
              <h2 className="text-4xl md:text-8xl font-head uppercase font-bold">
              ...
              <p className="text-xl hidden md:block">
                I know the basics of designing with Figma.
              </p>
            </li>
          </ul>
        </div>
